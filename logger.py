...
class Logger():
    ...
    def __init__(self, base_directory):
        ...
        self.refin_depth_images_directory = os.path.join(self.base_directory, 'data', 'refin-depth-images')
    ...
    def save_images(self, iteration, color_image, depth_image,refin_depth_img):
        ...
        refin_depth_img = np.round(refin_depth_img * 10000).astype(np.uint16) # Save refin_depth_img in 1e-4 meters
        cv2.imwrite(os.path.join(self.refin_depth_images_directory, '%06d.refin_depth.png' % iteration), refin_depth_img)
