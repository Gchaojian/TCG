...
class Robot(object):
    def __init__(self, workspace_limits, is_testing, test_preset_cases, config_file):
        ...
        # Make sure to have the server side running in coppalisim:
    ...
    def add_objects(self):
        ...
        for object_idx in range(self.num_obj):
            ...
            # 设置透明度参数
            transparency = 0.5  # 设置透明度，可以根据需要进行调整
            parameter_id = vrep.sim_objfloatparam_transparency_offset  # 透明度参数的ID
            ret = vrep.simxSetObjectFloatParameter(self.sim_client, self.object_handles, parameter_id, transparency, vrep.simx_opmode_blocking)
