...
import transCG.utils.logger as logger
import transCG.utils.builder as builder
...
class Inferencer(object):
    ...
    def __init__(self, cfg_path = os.path.join('configs', 'inference.yaml'), with_info = False, **kwargs):
        ...
        self.builder = builder.ConfigBuilder(**cfg_params)
    ...
    def inference(self, rgb, depth, target_size = (640, 480), depth_coefficient = 10.0, inpainting = True):
        """
        Inference.
        ...
        target_size: tuple of (int, int), optional, default: (640, 480), the target depth image size;
